...
public class CephS3Client {
    ...
    public static void main(String[] args) {
    	...
    	String accessKey = "60BO0SK9LBWP6AHV4RDU";
    	String secretKey = "wLs0IHcKfK8Ys0wX+jSBjBnOw2n9kCukgmSZK+ds";

/*
export ACCESS_KEY="60BO0SK9LBWP6AHV4RDU"
export SECRET_KEY="wLs0IHcKfK8Ys0wX+jSBjBnOw2n9kCukgmSZK+ds"
*/
